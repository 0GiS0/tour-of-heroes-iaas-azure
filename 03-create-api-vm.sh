...
# API_VM_PUBLIC_IP=$(az network public-ip show \
# --resource-group $RESOURCE_GROUP \
# --name ${API_VM_NAME}PublicIP \
# --query "ipAddress" -o tsv)

# # Copy the app to the api vm
# echo -e "Copy the api app to the api vm"
# scp -r tour-of-heroes-dotnet-api/bin/Debug/net7.0/publish/. $API_VM_ADMIN_USERNAME@$API_VM_PUBLIC_IP:/var/www/tour-of-heroes-api/
